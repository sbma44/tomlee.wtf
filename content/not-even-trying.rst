...
Besides, there are plenty of ways to get on Comcast's bad side without joining the pirate hordes — try running the `Joost <http://www.joost.com/>`__ beta on a few machines for a month and see if it doesn't earn you an angry letter or two. Or try running through a few dozen Linux distros to find one that suits you. I bet Comcast wouldn't like that one bit.
