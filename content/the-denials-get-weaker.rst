...
######################
:date: 2008-01-08 10:33
:author: admin
:category: music, tech
:slug: the-denials-get-weaker
:status: published
...
I'll admit I'm not an expert on the mixing and mastering process — Charles, maybe you can chime in? — but my impression is that compressing the hell out of a song requires considerably less work than mixing those alternate versions. So if you can get just a few hundred people to buy the crisp, uncompressed FLAC version of a song, I imagine that'd pay for its production costs. It's actually the audiophiles who are holding this back: their disdain for portable players and digital files is preventing support for the lossless FLAC format from hitting the market (`some players support it, of course <http://flac.sourceforge.net/links.html#hardware>`__, but not many).
...
(None of the preceding should be taken to mean that anyone buying `this <http://www.machinadynamica.com/machina31.htm>`__ is anything less than a complete moron.)
