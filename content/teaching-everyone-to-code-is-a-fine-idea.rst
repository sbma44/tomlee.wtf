...
########################################
:date: 2013-12-09 16:47
:author: admin
:category: Uncategorized
:slug: teaching-everyone-to-code-is-a-fine-idea
:status: published
...
Do you want to be able to quickly use a new product? Or organize a spreadsheet so that it will be useful later on? Do you want to know why your partner missed that SMS, or why the football broadcast looks blocky? Do you want to know `what to fear <http://gizmodo.com/fbi-can-secretly-activate-laptop-cameras-without-the-in-1478371370?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed%3A+gizmodo%2Ffull+%28Gizmodo%29>`__, and when you're being lied to, and `how <http://en.wikipedia.org/wiki/Man-in-the-middle_attack>`__?
