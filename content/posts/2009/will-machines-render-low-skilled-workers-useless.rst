...
#################################################
:date: 2009-08-09 19:45
:author: admin
:category: Uncategorized
:slug: will-machines-render-low-skilled-workers-useless
:status: published
...
Certainly some subset of tasks currently performed by humans will be difficult to automate for a long time yet.  But not only will technology improve, as Ryan acknowledges, but we can simply eliminate many tasks that are resistant to automation.  A computer can't have a conversation with a person the way that a customer service representative can.  But instead of resigning themselves to this fact, businesses have simply moved to eliminate this class of commercial interaction, substituting for it with websites, IVR systems and `brutal indifference <http://www.comcast.net>`__.
...
.. |mcterminator| image:: /static/2009/08/mcterminator-200x300.jpg
   :class: alignright size-medium wp-image-910
   :width: 200px
   :height: 300px
   :target: /static/2009/08/mcterminator.jpg
