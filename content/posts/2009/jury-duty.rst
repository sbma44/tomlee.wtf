...
I was called into voire dire for a murder trial in a courtroom that had seemingly been designed by the same firm that built our nation's system of bowling alleys (it will apparently soon be renovated to look more like a `cheesy starship set <http://www.gruzensamton.com/pop_project_all.asp?BuildingCode=&image=1&id=138#>`__). Things went pretty smoothly: I even managed not to crack up when the judge claimed that the crime occurred in a neighborhood called "Turkeyneck".
