...
When you draw boundaries between factions along planetary lines, it makes sense to insert race as a dimension in your story. And once that happens, I agree that an insulting and naive sort of primitivism is sure to follow -- something that Reihan gets at `here <http://www.forbes.com/2009/12/20/avatar-media-james-cameron-opinions-columnists-reihan-salam_print.html>`__ (though there's a *hell* of a lot of projection going on in that piece -- the movie says nothing about half the claims that Reihan makes about the Na'vi).
