...
#########################
:date: 2008-06-19 18:10
:author: admin
:category: tech
:slug: sufficiently-insufficient
:status: published
...
But the specifics of the update are even more cheer-inducing: `apparently there are some bugs in the update code <http://hackmii.com/2008/06/wii-menu-tp-hack-killer-analysis/>`__ which, when exploited in tandem, make it possible to continue using the TP hack. Hurrah!

All of this is comes from `hackmii.com <http://hackmii.com>`__ (via `Hack a Day <http://hackaday.com>`__ — yes, again), which seems to be home to some of the web's foremost Wii reverse engineers.
