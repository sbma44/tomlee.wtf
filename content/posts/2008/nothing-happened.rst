...
I'm still producing much more snot than ideas, so for now I'll just ask: anybody want to go to `Dorkbot <http://dorkbot.org/dorkbotdc/>`__ tomorrow night? Alberto Gaitan is presenting the second half of his talk on `Remembrancer <http://selforganizingsystem.org/co_rem.html>`__. It should be pretty interesting. Also on `the docket <http://dorkbot.org/dorkbotdc/>`__: MIDI goodness and a chat about NASA's newest Mercury probe by someone who helped write its software. Tomorrow, 7pm, GW, *free*.
