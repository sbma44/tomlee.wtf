...
**ALSO:** Somewhat less emphatically, let me add that I (predictably) don't really buy the argument that going after Palin will prompt a meaningful backlash. In terms of media narratives, sure — but nobody should care about that. The `depressing truth <http://matthewyglesias.theatlantic.com/archives/2007/11/smear_me_once.php>`__ seems to be that the first mover advantage overwhelms the final result of most societal deliberations.
