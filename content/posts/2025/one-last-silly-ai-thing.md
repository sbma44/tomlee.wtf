...
I was pleased by the response, and especially by [Drew Bruenig joining in the fun](https://bsky.app/profile/dbreunig.bsky.social/post/3m7dwgudaws2c). I also cherish the [reply](https://bsky.app/profile/swozey.bsky.social/post/3m7djd675rc2g) that deemed it "the most depressing this [he's] ever seen"--and yes, I am a parent!

I think [a lot of people don't realize--or are denying--just how impressive the current genAI models are](https://bsky.app/profile/tjl.bsky.social/post/3ma6vwpvwhc25). That's partly willful ignorance. But it's also partly the fact that leading-edge image generation requires enough compute that Google is charging for it. That means that to use it, you need to sign up for an expensive Gemini Plan or figure out how to connect a Google Developer account with billing details to their AI Studio web app (I did the latter). These barriers won't last for long, though.
