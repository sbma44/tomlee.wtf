...
#####################################################
:date: 2007-04-02 14:32
:author: admin
:category: tech
:slug: are-we-still-playing-net-neutrality-if-so-i-want-in
:status: published
...
Well, `Ezra's <http://ezraklein.typepad.com/blog/2007/04/net_neutrality_.html>`__ just put up a post about it, so maybe now's my chance. I disagree with Ezra (I think that the quality of phone service probably *is* a desirable differentiator for pizza delivery joints), but I do think Julian's being too blasé about a purely market-driven internet.

Although `building more bandwidth <http://www.techliberation.com/archives/041995.php>`__ is always the preferred solution, it seems clear that traffic-shaping has a place in network optimization. I'm even open to the idea that the market should help determine how it's implemented.
