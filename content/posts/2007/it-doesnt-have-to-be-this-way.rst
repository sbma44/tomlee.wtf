...
And, courtesy of `Michael <http://www.silbatron.com>`__, here comes a reminder of that fact. This one concerns a `free conference call service <http://www.freeconference.com/>`__ that we use at work:
...
Now, maybe it's not foul play. Lately there's been a rash of non-toll-free numbers attracting huge amounts of inbound traffic in order to `exploit legislative loopholes <http://www.techcrunch.com/2007/02/16/allfreecalls-shut-down/>`__. Maybe FreeConference.com was accidentally lumped in with them and the blocking will be temporary. Maybe they all resell POTS access from the same provider, who's accidentally blacklisted freeconference.com. Or maybe not.
