barely returned
###############
:date: 2007-09-17 10:59
:author: admin
:category: personal
:slug: barely-returned
:status: published
...
Otherwise: work, busy, etc. I really need some sort of system to crawl out from under September. `Inbox Zero <http://www.43folders.com/izero/>`__ might be a little ambitious, though. For now I'd settle for RSS Reader One Thousand.

I don't mean to just whine, though — things aren't all bleak. For instance, I'm continuing to make strides in the `struggle for the fair treatment of Espers <http://en.wikipedia.org/wiki/Final_fantasy_vi>`__. In fact, let me take this opportunity to announce that I believe we've reached an accord with the Empire! It's a momentous achievement, to be sure.
