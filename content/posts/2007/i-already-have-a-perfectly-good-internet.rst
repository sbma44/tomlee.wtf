...
########################################
:date: 2007-03-22 10:30
:author: admin
:category: personal
:slug: i-already-have-a-perfectly-good-internet
:status: published
...
I just don't see the point. What's it supposed to do? Keep me `up to date <http://en.wikipedia.org/wiki/Rss>`__ on my friends' activities? Let me `post photos <http://flickr.com>`__? Or `share links <http://del.icio.us>`__? Get `mobile updates <http://twitter.com>`__? `Plan <http://www.evite.com>`__ `events <http://www.upcoming.org>`__? Bah! I've already got technologies that I use for all this stuff. There's no reason to reroute all that activity through the blue & white blandness of a `cocky <http://www.google.com/search?q=%22a%20Mark%20Zuckerberg%20production%22>`__ `thief <http://www.thecrimson.com/article.aspx?ref=502722>`__.
