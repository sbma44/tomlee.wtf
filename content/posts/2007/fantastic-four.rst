...
**UPDATE:** A proof that a giant dude with enormous metal sideburns *can* be made to look totally rad, I offer up this screencap from the `Marvel Ultimate Alliance <http://www.marvelultimatealliance.com/>`__ videogame, which I found on `this <http://kungfurodeo.com/2006/09/27/marvel-ultimate-alliance-screen-captures/>`__ webpage. Given that this is just from a videogame cutscene and that the FF movie seemed to have a pretty big SFX budget, I'm confident that the creators could have come up with something cool.
