...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/800/0*6p4aTtUpVR3fPdi9
      :alt: Image for post
      :width: 200px
      :height: 240px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*ZgBBixW_758HHJ1Q
      :alt: Image for post
      :width: 500px
...
.. container:: float wp-block-embed-youtube wp-block-embed is-type-video is-provider-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio

   .. container:: wp-block-embed__wrapper

      https://www.youtube.com/watch?v=n47cfqZ_Mt0
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*m1MDgPivMZL8C0NZ
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*p_xXdrWLwVy21Y8y
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*p3Q0GtCpIpBnjYZS
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*RNzGLP88lYhwpRr9
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*t3ukz4PBGkj8zR7H
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*5ya0mGIbKDuXK1mX
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*-uARw5quzokb7Xvx
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*7PqwJMZTTyf5o1Fk
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*rt922y971BhOuGp6
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*njPWm9gq06ASMza3
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*29NbdXjYCgY1NZLa
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*mCzr1PlgzAhqmhrL
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*zMVihuJ2Um1ivT0l
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/480/0*Sjk7PuiEv1DwmXkW
      :alt: Image for post
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*gsbFY59SYRZ0NIEK
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*E33dLAWde1-tdTer
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*3RKFn-h9Cezx2mNy
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*FAZqzk68bRK5y5ZH
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*0PKggLjWYf-ciKIa
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*ePzVBBtk2MRav0NU
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*qJC3EAbW5J1rHh7H
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*iGcFra8vbYCiyZFs
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*QXbUpDpD_Dp1ZVPB
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1385/0*D_vGZ7TfFx8Ku4SU
      :alt: Image for post
      :width: 500px

.. container:: wp-block-image

   .. figure:: https://miro.medium.com/max/1400/0*41VBxh2Mkpczm8Xu
      :alt: Image for post
      :width: 500px
...
.. container:: wp-block-image
   ...
   .. container:: float aligncenter

      |Image for post|

This is `The Orange Show <https://www.orangeshow.org/>`__, an installation in Houston, Texas.
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/444/0*MjCDIbiX7R7RC9t2
      :alt: Image for post
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1000/0*Yj_i6CXAwGRQ0Vom
      :alt: Image for post
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1000/0*BHAScJDWH3jWsoqY
      :alt: Image for post
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1400/0*nqPIxcYZ7picDKxD
      :alt: Image for post
...
Don’t get me wrong: he’s celebrated. There are permanent displays. That room is `meticulously recreated in a Chicago art museum <https://www.art.org/henry-darger-room-collection>`__. If you look at the `Wikipedia article for Darger <https://en.wikipedia.org/wiki/Henry_Darger#In_popular_culture>`__ the sheer number of songs and other references to the Vivian Girls — the heroes of Darger’s work — it’s overwhelming.
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/413/0*u2QdoXchh41-gUPr
      :alt: Image for post
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1181/0*x7ixoICdLiZLgbaF
      :alt: Image for post
      :width: 700px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/650/0*0aUj_oqdVhz2NP0a
      :alt: Image for post
      :width: 700px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/1181/0*LYOwJCeJhoImwBU4
      :alt: Image for post
      :width: 700px
...
.. container:: wp-block-image
   ...
   .. figure:: https://miro.medium.com/max/640/0*fnrWlfM-uxhQuZpf
      :alt: Image for post
      :width: 700px
...
.. |Image for post| image:: https://miro.medium.com/max/1024/0*6aXVlFAPRYs_CF2E.jpg
.. |image1| image:: https://miro.medium.com/max/719/0*R3zDxCLI-88CszIx
.. |image2| image:: https://miro.medium.com/max/1024/0*n1RjJvSlrzJEOf_r.jpg
.. |image3| image:: https://miro.medium.com/max/1200/0*n0EfYpCcoULgX12c
