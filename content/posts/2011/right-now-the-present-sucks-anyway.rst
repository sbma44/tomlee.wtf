...
##################################
:date: 2011-01-08 17:51
:author: admin
:category: Uncategorized
:slug: right-now-the-present-sucks-anyway
:status: published
...
.. container::
   ...
   .. raw:: html
      ...
      <embed src="http://www.youtube.com/v/IQ4nwTTmcgs?fs=1&amp;hl=en_US" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="480" height="385">
...
I was prompted (through a clear chain of causation!) to search for the video after reading `this <http://www.concatenation.org/futures/whatsexpected.pdf>`__ (PDF), via `Trivium <http://chneukirchen.org/trivium/2011-01-04>`__. It's short and worth a look. It descends into improbable and grandiose flourishes after the first column (people like me would keep a Predictor on their keychain and then get on with their lives). But with all the excitement over `Daryl Bem's paper <http://www.wired.com/wiredscience/2010/11/feeling-the-future-is-precognition-possible/>`__ that's arisen during the last few months, I'm feeling pretty good about my odds of being able to buy a Predictor-like gadget from `DealExtreme <http://www.dealextreme.com/>`__ in the next decade or two.
