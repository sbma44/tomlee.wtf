...
#########################################################################
:date: 2011-06-18 16:00
:author: admin
:category: Uncategorized
:slug: some-probably-dumb-thoughts-about-the-tenability-of-campaign-finance-laws
:status: published
...
I love philosophical abstractions as much as the next guy, but let's get real: most types of communication are cheap. `This is about broadcast media <http://www.opensecrets.org/pres08/expend.php?cycle=2008&cid=n00009638>`__. The money-in-politics discussion is about domination of a small number of more-or-less zero-sum distribution channels, most of which are subject to physical constraints that necessitate a high level of regulation. Your freedom to speak within these channels is already severely limited in both a `legal <http://transition.fcc.gov/eb/oip/>`__ and `practical <http://www.google.com/search?q=nbc+won't+air+ad>`__ sense.
