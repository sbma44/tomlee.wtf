...
:slug: ask-me-about-the-direction-finding-motors-i-keep-strapped-to-my-ankle
:status: published
...
IBM's victory at Jeopardy has led to the usual woe-is-humans handwringing, including (charmingly) `from Jennings himself <http://www.slate.com/id/2284721/pagenum/all/>`__.

But look, while I agree that the logic of machines crowding out off-the-shelf humans is compelling, I think there's some reason for hope.  I, and probably most of you, already carry a substantial `neural prosthesis <http://www.apple.com/iphone/>`__ around with me all the time, which confers superhuman trivia capabilities at a level even more impressive than the Watson system.  It's just that a couple of the system buses are a bit slow.  The neural bus will remain relatively sluggish, but for now it's the interface that's the real problem.
