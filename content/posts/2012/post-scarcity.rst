...
**UPDATE:** I realized I should've linked to `this post <http://www.slate.com/blogs/moneybox/2012/04/05/slouching_toward_utopia.html>`__ by Yglesias; for how short it is, it really covers an incredible amount of territory.  Better still, I finally got around to reading `the Peter Frase essay <http://jacobinmag.com/winter-2012/four-futures/>`__ it links to, which is shockingly good (and includes the trenchant Star Trek analysis I crave). And that, in turn, links to `this Charles Stross blog post <http://www.antipope.org/charlie/blog-static/2011/10/a-cultural-experiment.html>`__, which is also very good.
