...
#######################################################
:date: 2012-03-12 12:35
:author: admin
:category: Uncategorized
:slug: lets-pause-and-promote-something-else-open-states
:status: published
...
Getting to fifty is a big deal, and I'm extremely proud of Sunlight and the Open States team for reaching this milestone.  No one's done this before; it took us years to do it ourselves. This data existed, but in a completely piecemeal manner -- there was no consistent location, API or data model. Getting it collected, cleaned and accessible will have real impacts for journalists, watchdogs and citizens.  If you saw `Sunlight's recent work on mandatory ultrasound legislation <http://reporting.sunlightfoundation.com/2012/virginia-ultrasound-law-image-few-others/>`__ -- well, suffice it to say that there's much more coming on that front, and Open States is what's going to make it possible.
