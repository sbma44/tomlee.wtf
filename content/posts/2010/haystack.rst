...
- The EFF says to `stop using Haystack <http://www.eff.org/deeplinks/2010/09/breaking-news-security-alert-stop-using-haystack>`__
- `The resignation letter of its main developer <http://calixte.tumblr.com/post/1120185415/no-more-haystack>`__
- `Ed Felten's take <http://www.freedom-to-tinker.com/blog/felten/why-did-anybody-believe-haystack>`__
...
I guess what I'm trying to say is that reporters should spend more time reading `Bruce Schneier <http://www.schneier.com/>`__.  Even the repetitive entries. *Especially* the repetitive entries.
