...
#################################
:date: 2010-02-16 11:35
:author: admin
:category: Uncategorized
:slug: posts-i-am-not-qualified-to-write
:status: published
...
If our world really is a `hologram <http://www.newscientist.com/article/mg20126911.300-our-world-may-be-a-giant-hologram.html?page=1>`__\ \*, what does is mean for the philosophy of mind that phenomenal experience\* seems to occur at the holographic level rather than at the level of the lower-dimensional surface\* (or brane, more technically, I guess)?  Does it bolster the case for consciousness-as-epiphenomenon (I think maybe, if the hologram can be created in multiple ways with varying underlying conditions, it nudges us toward an explicitly supervenient relationship)?
