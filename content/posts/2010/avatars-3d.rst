...
Today a gentleman named Daniel posted some information to the HacDC list explaining what's going on: the light isn't linearly polarized, it's *circularly* polarized.  I can't claim to really understand this, but the `relevant wikipedia page <http://en.wikipedia.org/wiki/Circular_polarization>`__ contains a diagram that almost fools me into thinking I do.  More from Daniel:
